    ...
    >
      ...
      {!prefersReducedMotion && (
        <div className="absolute inset-0 overflow-hidden">
          <motion.div
            className="absolute left-1/4 bottom-0 h-96 w-96 rounded-full bg-primary/5 blur-3xl"
            animate={{
              scale: [1, 1.2, 1],
            }}
            transition={{
          ...
          />
          <motion.div
            className="absolute right-1/4 top-0 h-96 w-96 rounded-full bg-primary/5 blur-3xl"
            animate={{
              scale: [1, 1.15, 1],
            }}
            transition={{
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-4">
            ...
            >
              <motion.div
                className="relative flex h-10 w-10 items-center justify-center rounded-lg bg-primary text-background shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 transition-all duration-300"
                whileHover={{ rotate: prefersReducedMotion ? 0 : 360 }}
                transition={{ duration: 0.6 }}
              >
                <Code2 className="h-6 w-6" aria-hidden="true" />
                <motion.div
                  className="absolute inset-0 rounded-lg bg-primary opacity-0 blur-md transition-opacity group-hover:opacity-50"
                  initial={false}
                />
              </motion.div>
              <span>Zcode</span>
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              IT agency specializing in custom websites and technical solutions. We build fast, reliable, and scalable solutions that solve real business problems.
            </p>
              ...
              {serviceLinks.map((link, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <motion.div
                      className="absolute bottom-0 left-0 h-0.5 w-0 bg-primary shadow-[0_0_8px_rgba(88,101,242,0.6)] transition-all group-hover:w-full"
                      initial={false}
                    />
                  </Link>
                </motion.div>
